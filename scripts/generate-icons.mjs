...
// Multi-size favicon (white-alpha on transparent — chosen universal design after
// adaptive light/dark proved unreliable in Chrome). favicon-original.ico kept for reference.
...
console.log(`favicon.ico (16/32/48 packed) — ${(icoStats.size / 1024).toFixed(1)} KB`);
